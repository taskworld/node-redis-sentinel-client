...
function customizeClientCreator (_options) {
  if (!(_options.RedisSingleClient && _options.RedisCommands)) {
    throw new Error('no RedisSingleClient or RedisCommands as parameters')
  }
...
exports.customizeClientCreator = customizeClientCreator
